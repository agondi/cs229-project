# -*- coding: utf-8 -*-
"""CS 229 Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ro1n5TGSupPXAgxa_42cNtX-jLbMJiS5
"""
...
for course_elem in course_elems:
    ...
    if len(courseAttributes.text.split("|")[0].split("Terms: ")))
#     else len(courseAttributes.text.split("|")[0].split("Terms: ") > 1:
#         courseTerms = courseAttributes.text.split("|")[0].split("Terms: ")[1]
    courseUnits = courseAttributes.text.split("|")[1].split("Units:")[1]
#     print(courseNumber)
#     print(courseUnits.strip())
